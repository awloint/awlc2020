...
const htmlBodyCancelled = (firstName, lastName) => {
    return `<table style='background-color: #d5d5d5;' border='0' width='100%' cellspacing='0'>
        ...
        <p>Thank you for taking the steps to register for AWLC Sierra Leone 2020 holding from 2nd – 5th April 2020 at Freetown Convention Center, Bintumani. However, your registration is not complete.</p>
...
exports.htmlBodyCancelled = htmlBodyCancelled;
const textBodyCancelled = (firstName, lastName) => {
    return `Dear ${firstName} ${lastName},
            Thank you for registering for AWLC Sierra Leone 2020 holding from 2nd – 5th April 2020 at Freetown Convention Center, Bintumani. However, your registration is not complete.
...
exports.textBodyCancelled = textBodyCancelled;
