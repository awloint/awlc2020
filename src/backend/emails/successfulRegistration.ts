const htmlBodySuccess = (firstName:string, lastName:string) => {
  return `<table style='background-color: #d5d5d5;' border='0' width='100%' cellspacing='0'>
        ...
        <p>Thank you for registering for AWLC Sierra Leone 2020 holding from 2nd – 5th April 2020 at Freetown Convention Center, Bintumani.</p>
...
const textBodySuccess = (firstName: string, lastName: string) => {
    return `Dear ${firstName} ${lastName},
            Thank you for registering for AWLC Sierra Leone 2020 holding from 2nd – 5th April 2020 at Freetown Convention Center, Bintumani.
...
export {htmlBodySuccess, textBodySuccess};