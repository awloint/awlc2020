const htmlBodyCancelled = (firstName: string, lastName: string) => {
...
const textBodyCancelled = (firstName: string, lastName: string) => {
...
export { textBodyCancelled, htmlBodyCancelled}